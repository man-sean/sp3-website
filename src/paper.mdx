...
<Comparison client:idle itemOneLabel="Compressed" itemTwoLabel="Ground truth">
...
Use the `BibTeX` component to display a paper citation with a copy button.

<BibTeX text={String.raw`@misc{roman2024academic,
